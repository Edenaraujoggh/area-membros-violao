                    ...
                    <div className="flex items-center gap-3 w-full">
                      <div className="relative shrink-0">
                        <div className="w-14 h-14 rounded-full border-2 border-yellow-400 overflow-hidden bg-gray-800 shadow-lg">
                          <img src="https://jynykwoseopmtpqtfenw.supabase.co/storage/v1/object/public/RANKING/fff.jpg"{/* 🥉 foto*/}
                           alt="Ouro" className="w-full h-full object-cover" onError={(e) => e.currentTarget.style.display='none'} />
...
<div className="w-14 h-14 rounded-full border-2 border-yellow-400 overflow-hidden bg-gray-800 shadow-lg">
  <img src="..." alt="Ouro" className="w-full h-full object-cover" onError={(e) => e.currentTarget.style.display='none'} />
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-white font-bold text-sm truncate leading-tight">João Caipira</p>{/* 🥉 Ouro João Caipira*/}
                    ...
                    <div className="flex items-center gap-3 w-full">
                      <div className="relative shrink-0">
                        <div className="w-14 h-14 rounded-full border-2 border-gray-400 overflow-hidden bg-gray-800 shadow-lg">
                          <img src="https://jynykwoseopmtpqtfenw.supabase.co/storage/v1/object/public/RANKING/Jonivon.png"{/* 🥉 foto*/} 
                          
                          
                          alt="Prata" className="w-full h-full object-cover" onError={(e) => e.currentTarget.style.display='none'} />
                          <div className="w-14 h-14 rounded-full border-2 border-yellow-400 overflow-hidden bg-gray-800 shadow-lg">
  <img src="..." alt="Ouro" className="w-full h-full object-cover" onError={(e) => e.currentTarget.style.display='none'} />
</div>
                        </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-white font-bold text-sm truncate leading-tight">Jonivon JS</p>{/* 🥉 Prata Jonivon JS */}
                    ...
                    <div className="flex items-center gap-3 w-full">
                      <div className="relative shrink-0">
                        <div className="w-14 h-14 rounded-full border-2 border-amber-700 overflow-hidden bg-gray-800 shadow-lg">
                          <img src="https://jynykwoseopmtpqtfenw.supabase.co/storage/v1/object/public/RANKING/Captura%20de%20tela%202026-02-23%20133400.png"{/* 🥉 foto*/}
                          
                          alt="Bronze" className="w-full h-full object-cover" onError={(e) => e.currentTarget.style.display='none'} />
                          <div className="w-14 h-14 rounded-full border-2 border-yellow-400 overflow-hidden bg-gray-800 shadow-lg">
  <img src="..." alt="Ouro" className="w-full h-full object-cover" onError={(e) => e.currentTarget.style.display='none'} />
</div>
                        </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-white font-bold text-sm truncate leading-tight">Thiago Consoli</p>{/* 🥉 Bronze Thiago Consoli */}
